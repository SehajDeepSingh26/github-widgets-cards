...
export const writeSVG = (folder: string, filename: string, svgString: string) => {
...
export const generatePreviewMarkdown = (isInGithubAction: boolean) => {
...
function getThemeMarkdown(urlPrefix: string): string {
  let result = ""
  result += `
[![](${urlPrefix}/0-profile-details.svg)](https://github.com/sehajdeepsingh26/github-profile-summary-cards)
[![](${urlPrefix}/1-streak-stats.svg)](https://github.com/sehajdeepsingh26/github-profile-summary-cards) [![](${urlPrefix}/2-repos-per-language.svg)](https://github.com/sehajdeepsingh26/github-profile-summary-cards)
[![](${urlPrefix}/3-most-commit-language.svg)](https://github.com/sehajdeepsingh26/github-profile-summary-cards) [![](${urlPrefix}/4-stats.svg)](https://github.com/sehajdeepsingh26/github-profile-summary-cards)
[![](${urlPrefix}/5-productive-time.svg)](https://github.com/sehajdeepsingh26/github-profile-summary-cards)
`
  return result
}
